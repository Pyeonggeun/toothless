		...
		<div class="row">
			...
			<div class="col">
				<div class="row border-bottom border-4 border-dark mb-3 pt-3">
					<div class="col fw-bold fs-3">글 작성</div>
				</div>
				...
				<div class="row ">
					<div class="col mb-3">
						<textarea name="board_contents" class="form-control" rows="18" placeholder="내용"></textarea>
					</div>
				</div>
				...
				<div class="row ">
					<div class="col ">
						<div class="form-floating">
  							<textarea name="board_answer" class="form-control form-control-sm" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
  							<label for="floatingTextarea2">답변내용</label>
						</div>
					</div>
				</div>	
