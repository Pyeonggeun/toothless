			...
			<div class="col">
				...
				<div class="row mt-3">
					...
					<div class="col-2 pe-0">
						<a class="text-dark link-offset-2 link-underline link-underline-opacity-0" href="./companyPostingListPage?com_pk=${jobPosting.companyDto.com_pk}">${jobPosting.companyDto.com_name}</a>
					</div>
					<!-- 공고제목 -->
				...
				<div class="row mt-1 pb-3 border-bottom">
					...
					<div class="col-7 ps-0">
						<span class="text-primary">#&nbsp;${jobPosting.jobFieldCategoryDto.job_field_category_name} #&nbsp;${jobPosting.jobPostingDto.job_position}
