							...
							<table class="table table-striped table-hover text-center">
								...
								<tbody>			
									<tr>					
										...
										<th scope="col">
											<a href="./resumeDetailPage?resume_pk=${resumeDto.resume_pk }" style="color: black; text-decoration: none;">${resumeDto.resume_title }</a>
										</th>
										<th scope="col">
								...
								<tbody>
									<c:forEach items="${resumeList }" var="list">
										<tr>					
											...
											<th scope="col">
												<a href="./resumeDetailPage?resume_pk=${list.resume_pk }" style="color: black; text-decoration: none;">${list.resume_title }</a>
											</th>
											<th scope="col">
