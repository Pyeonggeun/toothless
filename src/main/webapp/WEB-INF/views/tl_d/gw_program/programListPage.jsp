					...
					<div class="col">
						...
						<c:forEach items="${programList}" var="list">
							<div class="row border-bottom border-bs-border pb-3 mb-3">
								...
								<div class="col"><a class="btn text-truncate ms-4" href="./programViewDetailsPage?program_pk=${list.programDto.program_pk}" style="max-width: 500px;">${list.programDto.prg_name}</a></div>
