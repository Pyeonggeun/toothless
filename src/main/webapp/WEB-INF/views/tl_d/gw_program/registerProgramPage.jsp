	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col">
				...
				<form action="./registerProgramProcess" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-2"></div>
						...
						<div class="col mt-3">
							...
							<div class="row mt-3">
								<div class="col">
									...
									<div class="row">
										<input type="text" name="prg_name" class="form-control" placeholder="프로그램명을 입력해주세요.">
									</div>
								</div>
							</div>
							...
							<div class="row mt-3"> 
								<div class="col"> 
									...
									<select class="form-select" name="program_category_pk" >
									  <option disabled selected>프로그램 카테고리를 선택해주세요.</option>
							...
							<div class="row mt-3">
								<div class="col">
									...
									<div class="row mb-3">
										<textarea class="form-control" name="prg_location" placeholder="프로그램 내용을 입력해주세요."></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row mt-3">
								<div class="col">
									...
									<div class="row mb-3">
										<input class="form-control form-control-sm" name="prg_apply_number" type="text">
									</div>
								</div>
							</div> 
