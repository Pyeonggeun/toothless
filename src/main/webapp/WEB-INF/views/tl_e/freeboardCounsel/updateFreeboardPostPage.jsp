	...
	<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="row"><div class="col text-center"> -현재 상담자유게시판에 <span class="fw-bold">게시글을 수정</span> 하는 페이지 입니다. - </div></div>
					<div class="row py-2"><div class="col"> <!--공간주는--> </div></div>
					...
					<div class="row">
						...
						<div class="col-10">
							<div class="row py-2"><div class="col">	<input id="inputTitle" class="form-control" name="title" type="text" style="width:100%; height:2em; border-start: none; border-end: none;" placeholder="${pickpostMap.freeboardPost.title}"> </div></div>
								<div class="row text-start pt-1 pb-2 ps-1"><div class="col"><i class="bi bi-person-vcard fs-5"></i>  <span class="fs-6">현재 게시글 수정자 </span> <span class="fs-5">${sessionStudentInfo.name}</span> <span class="fs-6">님</span> </div></div>
							<div class="row"><div class="col"> <textarea id="inputText" class="form-control" name ="text" style="width:100%; height:25em;" placeholder="${pickpostMap.freeboardPost.text}"></textarea> </div></div>
							
							<div class="row text-center py-2"><div class="col"> <input type="button" onclick="formSubmit()" class="btn fs-5 py-1 rounded text-white qwer" style="--bs-border-opacity: .7; background-color: #8FBC8F;" value="게시글 수정 완료"> </div></div>						
						</div>
