	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col mx-0 px-0" style="height: 35em;">
				...
				<div style="color: white; position: relative; font-size: 1.4em; bottom: 148%; transform: translate(-50%, -50%); text-align: center; left: 27.6%;">오프라인 상담</div>
				<div style="color: white; position: relative; font-size: 1.4em; bottom: 147%; transform: translate(-50%, -50%); text-align: center; left: 22.3%;">상담사 선택 후 일정을 선택해주세요</div>		
