...
<script>
	...
	function resigterCounselorProcess(){
    	...
    	let address =  
        	...
        	"우편번호 " + document.getElementById('postcode').value
                                    ...
                                    <div class="row">
                                        <div class="col">
                                        	<div class="row">
                                        		...
                                        		<div class="col-auto">
                                        			<button class="btn btn-secondary" onclick="openDaumPostcode()">우편번호 찾기</button>                                        			
                                        		</div>
                                        	</div>
                                        	<div class="row mt-2">
                                        		<div class="col">
                                        	...
                                        	<div class="row mt-2">
                                        		...
                                        		<div class="col">
                                        			<input type="text" id="extraAddress" class="form-control" placeholder="참조주소">
                                        		</div>                                        	
                                       		</div>                                      
