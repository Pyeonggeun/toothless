<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="row py-2">
		<div class="col-1 pe-2 text-end">
			<a href="./counselCenterStaffMainPage"><img src="../../resources/img/another/logo_black.png" alt="" style="height: 4em;"></a>
		</div>
		<div class="col-3 mt-2 ps-0 fw-bold fs-3 text-start ">
			<a href="./counselCenterStaffMainPage" class="link-dark link-offset-2 link-underline link-underline-opacity-0">MK University<span class="fs-6 link-dark link-offset-2 link-underline link-underline-opacity-0"> | </span> <span class="fs-5 link-offset-2 link-underline link-underline-opacity-0">상담센터</span></a> 
		</div>
		<div class="col-3"></div>
