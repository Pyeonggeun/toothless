...
<div class="col-3 me-3"><!-- 여기부분은 목차부분 -->
    ...
    <div id="rowbox1" class="row" style="border-bottom: 0.01em solid #161313;" onmouseover="changeColor(1)" onmouseout="restoreColor(1)">
        <div id="colbox1" class="col py-3" style="font-size: large;">
        	<a href="./dm_dormCapacity" style="text-decoration: none;">
            <span class="navimenu1" style="color: black;">수용인원 현황</span></a>       
        </div>
    </div>
    <div id="rowbox2" class="row" style="border-bottom: 0.01em solid #161313;">
        <div id="colbox2" class="col py-3" style="font-size: large;">
        	<a href="./dm_dormBulidingStatus" style="text-decoration: none;" onmouseover="changeColor(2)" onmouseout="restoreColor(2)">
            <span class="navimenu2" style="color: black;">건물 현황</span></a>       
        </div>
    </div>
</div><!-- ㅋ-->