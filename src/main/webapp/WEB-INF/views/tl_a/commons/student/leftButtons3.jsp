...
<div class="col-3 me-3"><!-- 여기부분은 목차부분 -->
    ...
    <div id="rowbox1" class="row" style="border-bottom: 0.01em solid #161313;">
    	...
    	<a href="./mj_dormPosted" style="text-decoration: none;" onmouseover="changeColor(1)" onmouseout="restoreColor(1)">
            <span class="navimenu1" style="color: black;">공고 및 입주신청</span>       
        </a>
        </div>
    </div>
    <div id="rowbox2" class="row" style="border-bottom: 0.01em solid #161313;">
        <div id="colbox2" class="col py-3" style="font-size: large;">
        <a href="./dm_dormSelectionGuide" style="text-decoration: none;" onmouseover="changeColor(2)" onmouseout="restoreColor(2)">
            <span class="navimenu2" style="color: black;">선발 안내</span></a>         
        </div>
    </div>
    <div id="rowbox3" class="row" style="border-bottom: 0.01em solid #161313;">
        <div id="colbox3" class="col py-3" style="font-size: large;">
        <a href="./dm_streetDistribution" style="text-decoration: none;" onmouseover="changeColor(3)" onmouseout="restoreColor(3)">
            <span class="navimenu3" style="color: black;">거리 배점표</span></a>         
        </div>
    </div>
    <div id="rowbox4" class="row" style="border-bottom: 0.01em solid #161313;">
        <div id="colbox4" class="col py-3" style="font-size: large;">
        <a href="./dm_paymentMoney" style="text-decoration: none;" onmouseover="changeColor(4)" onmouseout="restoreColor(4)">
            <span class="navimenu4" style="color: black;">납부금 안내</span></a>         
        </div>
    </div>
    <div id="rowbox5" class="row" style="border-bottom: 0.01em solid #161313;">
        <div id="colbox5" class="col py-3" style="font-size: large;">
        <a href="./mj_announcePassPage" style="text-decoration: none;" onmouseover="changeColor(5)" onmouseout="restoreColor(5)">
            <span class="navimenu5" style="color: black;">합격 조회</span></a>         
        </div>
    </div>
</div>