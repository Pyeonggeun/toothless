...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col mx-5">
			...
			<div class="row">
				<div class="col border py-4 mx-2 rounded border-dark btn text-center" style="background-color: black;">
					<div class="row">
				...
				<div class="col border py-4 mx-2 rounded border-dark btn text-center" onclick="location.href='./dm_readRoomAssignmentB'">
					<div class="row">
