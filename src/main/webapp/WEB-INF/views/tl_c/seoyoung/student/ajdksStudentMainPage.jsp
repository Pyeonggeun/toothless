							...
							<div class="row ms-5 me-5 mt-4 pt-3">
								...
								<div class="col-6 me-4 pe-4">
									...
									<div class="row fs-6 pt-1 pb-1 my-1">
										...
										<div class="col-7 fw-semibold text-dark-emphasis">[공지]
											[현장실습] 인턴 채용 안내</div>
								...
								<div class="col">
									...
									<div class="row fs-6 pb-2 my-1 border-bottom">
										...
										<div class="col-3  text-center border-start"
											style="font-size: 0.95em">학기 중 4개월 이상</div>
									...
									<div class="row fs-6 pb-2 my-1 border-bottom">
										<div
											class="col  text-center fw-semibold text-dark-emphasis border-end">신청시기</div>
										<div class="col-7 text-center" style="font-size: 0.95em">5월,
											11월 공지</div>
										<div class="col-3  text-center border-start"
											style="font-size: 0.95em">1월, 7월 공지</div>

									</div>
									<div class="row fs-6 pb-2 mt-1 border-bottom">
										<div
											class="col  text-center fw-semibold text-dark-emphasis border-end">신청자격</div>
										<div class="col-10 text-center" style="font-size: 0.95em">3,
											4학년 재학생</div>
									</div>
								</div>
						...
						<div class="row ms-5 me-5 mt-1 pt-3 mb-5">
							...
							<div class="col me-4 ms-4">
								...
								<div class="row fs-6 pb-4 my-1 border-bottom">
									...
									<div class="col-2  text-center" style="font-size: 0.9em">직원</div>
									<div class="col-4" style="font-size: 0.9em">
										현장실습 대학정보공시 관리<br>현장실습온라인시스템 운영 <br>현장실습 설명회 운영<br>우수인재
										추천
									</div>
									<div class="col-3 text-center" style="font-size: 0.95em">02-940-5606</div>
								</div>
