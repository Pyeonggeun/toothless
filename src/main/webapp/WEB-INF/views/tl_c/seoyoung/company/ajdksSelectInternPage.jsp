								...
								<tbody>
									<c:forEach items="${list2}" var="selectionStudent">
										<tr>
											...
											<td scope="row">
												<div class="modal modal-fullscreen  modal-dialog-scrollable"
															...
															<div class="modal-body px-5" style="overflow-y: auto">
																...
																<div class="row mx-3 pe-3">
																	...
																	<div class="col-2 text-center">
																		<div class="row border" style="height: 300px;">
																			<img
																				src="/Git_imageFile/${selectionStudent.SELF_INTRODUCTION_IMG}">
																		</div>
																	</div>
																	<div class="col-3">
																		<div
																	...
																	<div class="col-7  text-center ">
																		<div
																			...
																			style="height: 75px;">${selectionStudent.NAME}
																...
																<div class="row  px-4">
																	...
																	<div class="col-4">
																		<div
																			class="row border d-flex align-items-center justify-content-center"
																			style="height: 50px;">${selectionStudent.NAME}</div>
																	</div>
																					...
																					<table class="table text-center align-middle ">
																						...
																						<tbody>
																							<c:forEach items="${CertificationList}"
																								var="CertificationList" varStatus="loopStatus">
																								<tr>
															...
															<div class="row">
																<div class="modal-footer">
																	<a
																		...
																		class="btn bbtn btn-secondary" data-bs-toggle="modal"
																		role="button">불합격 </a> <a
