	...
	<div class="col">
		<div class="row">
			<div class="col mx-5">
				...
				<c:choose>
					<c:when test="${evaluations.didProfessorEvaluateIntern eq '0'}">
						<div class="row">
							<div class="col px-4 py-3 mt-3" style="background-color:#e6ecf5">
								<div class="row">
									<div class="col mx-2 py-2">
										<i class="bi bi-exclamation-triangle"></i>&nbsp;&nbsp;실습생 평가를 우선적으로 완료해주시길 바랍니다.
									</div>
								</div>
							</div>
						</div>
				...
				<div id="notice" class="row mt-4" style="font-size:0.85em">
					<div class="col border mt-2 bg-light">
						<div class="row">
							<div class="col px-4 py-4 text-dark-emphasis">
								...
								<div class="row">
									<div class="col mt-2">
										- 현재 페이지에서 수정 및 삭제는 불가합니다.
									</div>
								</div>
								<div class="row">
									<div class="col mt-2">
										- 산업체의 평가에 대한 문의는 담당 산업체에 문의하여 주시길 바랍니다.
									</div>
								</div>
							</div>
						</div>
