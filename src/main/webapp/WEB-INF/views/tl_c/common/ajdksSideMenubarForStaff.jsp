		...
		<div class="col">
			...
			<div class="content text-white-50">
				<div class="row pt-2 ps-2">
					<div class="col ps-4">
						<span style="font-size: 0.9em; cursor: pointer;" onclick="location.href='../woojae/ajdksRegisterCompanyPage'">&gt;&nbsp;산업체 등록</span>
					</div>
				</div>
				<div class="row py-2 ps-2">
					<div class="col ps-4">
						<span style="font-size: 0.9em; cursor: pointer;" onclick="location.href='../woojae/ajdksRegistedCompanyPage'">&gt;&nbsp;산업체 조회</span>
					</div>
				</div>
			</div>
		</div>
