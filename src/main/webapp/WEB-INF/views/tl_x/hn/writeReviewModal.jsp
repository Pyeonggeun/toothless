    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <textarea class="form-control focus-ring focus-ring-light" rows="10em" style="font-size: 0.85em;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer border-0 pt-0 pb-2">
                <button class="btn text-white fw-bold" style="background-color: #7844ae; font-size: 0.8em;">등록하기</button>
            </div>
        </div>
    </div>
</div>